...
// Pack a barrel archive for network sharing, collapsing all the zero bytes
BRL_Error              BRL_Pack(BRL_Archive* arch);

// Unpack a barrel archive once on the disk, and use punch hole (if enabled) to collapse the size on disk again
